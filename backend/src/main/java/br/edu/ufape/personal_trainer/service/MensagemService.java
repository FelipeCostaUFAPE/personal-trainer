...
public class MensagemService {
    ...
    public Mensagem criar(MensagemRequest request, Long chatId) {
        ...
        SecurityUtil.requireParticipantOfChatOrAdmin(chat, "Usuário não pertence a este chat");
        boolean enviadoPeloAluno = chat.getAluno().getEmail().equals(SecurityUtil.getCurrentEmail());
