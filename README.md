...
- Criação restrita: apenas entre aluno e seu personal vinculado
...
- Criação de plano e adição de itens (inclusive duplicados)
...
Para executar os testes via CLI:

```bash
mvn test
```

## 8. Guia de Execução da API
