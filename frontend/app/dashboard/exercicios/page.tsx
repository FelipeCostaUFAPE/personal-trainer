...
export default function ExerciciosPage() {
  ...
  // === CONTROLE DE ACESSO (MÁGICA DE ESCONDER O BOTÃO) ===
  ...
  // Nova função para descobrir quem está logado
  const verificarPermissaoAdmin = async () => {
    try {
      ...
      // Se a rota do Admin responder 200, ele é o Admin e vê o botão!
    ...
    <div>
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-3">
          ...
          {/* BOTÃO MÁGICO: SÓ APARECE SE FOR ADMIN */}
          {isAdmin && (
            <button 
        ...
        <div className="lg:col-span-2 bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden shadow-xl h-fit">
          ...
          {exercicios.length === 0 ? (
            ...
            <table className="w-full text-left text-sm text-zinc-300">
              <thead className="bg-zinc-950/30 text-zinc-500 border-b border-zinc-800">
                <tr>
