...
interface PlanoDeTreino {
  ...
  dataFim: string;
  alunoId: number;
  // O Java pode ou não trazer o nome do aluno aqui dependendo do seu DTO, 
  // mas vamos focar nos dados principais do plano primeiro.
}
            ...
            <tbody className="divide-y divide-zinc-800">
              {planos.map((plano) => (
                <tr key={plano.id} className="hover:bg-zinc-800/50 transition-colors">
                  ...
                  <td className="px-6 py-4 capitalize">{plano.objetivo}</td>
